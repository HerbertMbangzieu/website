  ...
  return (
    <>
      <div className="w-full text-white font-quicksand grid grid-cols-2 p-2 md:p-4 rounded-lg bg-gradient-to-tr from-[#001] to-[#003] shadow-inner shadow-slate-800">
        <div id="logo" className="text-2xl lg:text-3xl text-left font-bold">
          <span className="text-3xl text-lime-400">H</span>erbert
          <span className="text-3xl text-lime-400">M</span>bangzieu
        </div>

        <div>
          <div id="menu" className="hidden lg:flex text-md justify-end pt-2">
            <a
              href="#home"
      ...
      >
        ...
        "
        >
          <li className="my-4 hover:text-lime-400">
            <a href="#home">Home</a>
          </li>
          <li className="my-4 hover:text-lime-400">
